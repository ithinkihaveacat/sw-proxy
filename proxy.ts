 ...
 */
export function newResponse(res: Response, headerFn?: (h: Headers) => Headers): Promise<Response> {
 ...
 */
export function newRequest(req: Request, headerFn?: (h: Headers) => Headers): Promise<Request> {
